 ...
 */
final class Version20240912130701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section ADD section_title VARCHAR(255) NOT NULL, ADD section_description VARCHAR(600) NOT NULL');
